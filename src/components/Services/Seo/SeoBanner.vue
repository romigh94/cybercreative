...
<section class="relative py-24 overflow-hidden" style="background-color: #0E0F11;">
  <div class="container px-4 mx-auto">
    <div class="flex flex-wrap -m-8">
      ...
      <div class="w-full md:w-1/2 p-8">
        <img class="md:mr-0" src="https://images.unsplash.com/photo-1674027326254-88c960d8e561?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMzIzMzB8MHwxfHNlYXJjaHwxMXx8c2VhcmNoJTIwZW5naW5lJTIwb3B0aW1pemF0aW9ufGVufDB8fHx8MTcwOTEzMTk0NXww&ixlib=rb-4.0.3&q=85&w=1920" alt="">
      </div>
    </div>
  </div>
</section>
